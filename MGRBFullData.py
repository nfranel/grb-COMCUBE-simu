...
class GRBFullData:
  ...
  def __init__(self, data_list, sat_info, burst_time, sim_duration, num_sat, bkg_data, mu_data, ergcut, armcut,
    ...
    if len(data_list) == 0:  # Empty object for the constellation making
      ...
      print("==========================================================================")
      print("==========================================================================")
      print(f"data_list, sat_info, burst_time, sim_duration, num_sat, bkg_data, mu_data, ergcut, armcut, geometry, save_time, corr, polarigram_bins   :\n {data_list}, {sat_info}, {burst_time}, {sim_duration}, {num_sat}, {bkg_data}, {mu_data}, {ergcut}, {armcut}, {geometry}, {save_time}, {corr}, {polarigram_bins}")
