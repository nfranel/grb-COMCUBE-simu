...
class Catalog:
  ...
  def grb_distribution(self):
    ...
    ax2.hist(gbm_flnc, bins=bins2, histtype="step", color="blue", label=f"GBM, {len(gbm_flnc)} GRB", weights=[gbmcorrec] * len(gbm_flnc))
    ax2.hist(long_gbm_flnc, bins=bins2, histtype="step", color="red", label=f"GBM long, {len(long_gbm_flnc)} GRB", weights=[gbmcorrec] * len(long_gbm_flnc))
    ax2.hist(short_gbm_flnc, bins=bins2, histtype="step", color="green", label=f"GBM short, {len(short_gbm_flnc)} GRB", weights=[gbmcorrec] * len(short_gbm_flnc))
    ...
    ax3.hist(gbm_ph_flux, bins=bins3, histtype="step", color="blue", label=f"GBM, {len(gbm_ph_flux)} GRB", weights=[gbmcorrec] * len(gbm_ph_flux))
    ax3.hist(long_gbm_ph_flux, bins=bins3, histtype="step", color="red", label=f"GBM long, {len(long_gbm_ph_flux)} GRB", weights=[gbmcorrec] * len(long_gbm_ph_flux))
    ax3.hist(short_gbm_ph_flux, bins=bins3, histtype="step", color="green", label=f"GBM short, {len(short_gbm_ph_flux)} GRB", weights=[gbmcorrec] * len(short_gbm_ph_flux))
    ...
    ax4.hist(gbm_ph_pflux, bins=bins4, histtype="step", color="blue", label=f"GBM, {len(gbm_ph_pflux)} GRB", weights=[gbmcorrec] * len(gbm_ph_pflux))
    ax4.hist(long_gbm_ph_pflux, bins=bins4, histtype="step", color="red", label=f"GBM long, {len(long_gbm_ph_pflux)} GRB", weights=[gbmcorrec] * len(long_gbm_ph_pflux))
    ax4.hist(short_gbm_ph_pflux, bins=bins4, histtype="step", color="green", label=f"GBM short, {len(short_gbm_ph_pflux)} GRB", weights=[gbmcorrec] * len(short_gbm_ph_pflux))
